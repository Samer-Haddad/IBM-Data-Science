...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style={'width':300, 'padding':3, 'font-size':20, 'textAlign': 'center'}
        )
    ]),
...
def update_output_container(selected_statistics, input_year=None):
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
            figure=px.bar(unemp, color = 'Vehicle_Type',
            x='unemployment_rate',
            y='Automobile_Sales',
        ...
        return [
            ...
            style={
                    ...
                    "margin-left": "20px",
                    "verticalAlign": "top"
                    }), #,style={'font-size': 40, 'display': 'flex'}
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(
            ...
            x='Month',
            y='Automobile_Sales',
            title=f'Automobile Sales for year {input_year}'))
